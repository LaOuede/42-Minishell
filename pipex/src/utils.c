...
/*   Updated: 2023/05/09 10:12:40 by csenand          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// Ajout de la liste chainée
	data->token = token;
	//
		
	// Cela va etre remplacé par une liste chainée
	data->av = av;
	data->ac = ac;
	
	data->cmd_nb = ac - 3; // au lieu de prendre des arg count, il faudra compter le nb de cmds dans la list chainée
